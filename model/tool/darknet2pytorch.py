...
import numpy as np
from model.tool.region_loss import RegionLoss
from model.tool.yolo_layer import YoloLayer
from model.tool.config import *
from model.tool.torch_utils import *
    ...
    def create_network(self, blocks):
        ...
        for block in blocks:
            if block['type'] == 'net':
                ...
                # gan_models.append(Upsample_interpolate(stride))
